...
# Logic: Crawl "Nghị định" (Decrees) from VBPL.vn
# Scope: Last 3 years (2025, 2024, 2023)
# URL: idLoaiVanBan=20

BASE_URL = "https://vbpl.vn/TW/Pages/vanban.aspx?idLoaiVanBan=20&dvid=13&Page={}"
DOMAIN = "https://vbpl.vn"
OUTPUT_FILE = r"e:\VSCODE_WORKSPACE\VNPT\data\decrees_vbpl_2019_2000.json"
TARGET_YEARS = [2019, 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003, 2002, 2001, 2000]
...
def crawl():
    ...
    print(f"Starting crawl for 'Nghị định' (Decrees) years {TARGET_YEARS}...")
            ...
            for li in items:
                ...
                if issued_date:
                    ...
                    if year in TARGET_YEARS:
                        ...
                        print(f"  [STOP] Found older decree: {year} < {min(TARGET_YEARS)}. Stopping.")
                        stop_crawl = True
                        break
                else:
                    pass
    ...
    print(f"Crawl finished. Collected {len(results)} decrees.")
